...
const WelcomeScreen = () => {
  ...
  const viewableItemChange = useRef(
  ...
  return (
    <View style={styles.container}>
      <View style={[globalStyles.centerd, {flex: 0.7}]}>
          ...
          <View style={styles.IndicatorWrapper}>
            <Animated.View
              style={[
                ...
                {
                  transform: [{scaleX: SlideOneScale}],
                  borderRadius: currentIndex ? borderRadius.SM : 3,
            ...
            <Animated.View
              style={[
                styles.SlideIndicator,
                {
                  transform: [{scaleX: SlideTwoScale}],
                  borderRadius: !currentIndex ? borderRadius.SM : 2,
                  backgroundColor: !currentIndex
                    ? colors.lightPrimary
                    : colors.primary,
                },
